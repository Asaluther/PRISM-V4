...
> 2026-09-11 v2.2 | 覆盖 2026-09-07 至 09-11 的完整研究记录（v2.2 新增：V6 收官系列——权重约束、遗忘基准、跨域适应 demo、终端效率三问补完、MQAR 否定性结果）
> 关键词：非 Transformer 架构、预测编码、样本效率、因果性、消融方法学
> **代码与数据已开源**：https://github.com/Asaluther/PRISM-V4
> 单卡 RTX 4080 16GB，PyTorch 2.14，≈130 有效训练 run + 40 V6 收官实验（另含 75 项作废归档；口径详见附录 B）
